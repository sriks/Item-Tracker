...
**Tabs (in order):**
1. **Ask** — landing screen, primary action (SF Symbol: `magnifyingglass`)
...
| Element | Size | Weight | Colour (dark) |
|---|---|---|---|
| Page title | 34pt | Bold (700) | `primaryText` |
| Subtitle | 15pt | Regular | `secondaryText` |
| Section label | 12pt | Semibold (600) | `tertiaryText` — uppercase |
| Recent question | 15pt | Regular | `primaryText` at `opacity(0.82)` |
| Answer pill text | 13pt | Medium (500) | `answerPillForeground` |
| Chip text | 14pt | Regular | `secondaryText` |
| Search placeholder | 16pt | Regular | `tertiaryText` |
| Tab label | 10pt | Medium (500) | active: `activeTabForeground`, inactive: `tertiaryText` |

### App header
- Logo: 32×32pt rounded rect (`cornerRadius: 9`), white background in dark mode, filled with app icon mark
- App name: "ItemTracker", 15pt semibold

### Large title
- "Where is it?" — 34pt bold, tracking: `-1`
- Subtitle: "Ask in plain English" — 15pt, `secondaryText`
...
- Search icon: SF Symbol `magnifyingglass`, 16pt, `secondaryText`
...
- Tab icons: SF Symbols at 22pt, `weight: .regular`
...
- Large title styling: `.font(.system(size: 34, weight: .bold))` with `tracking: -1`
